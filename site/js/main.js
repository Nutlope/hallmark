...
const COPY = {
  ...
  newsprint: {
    ...
    title: HERO_TITLE,
    lede: "Twenty-one themes. Twenty-one named page shapes. Fifty component archetypes — fourteen navs, eight footers, four hero polish patterns. A 57-gate slop test that gates every output before it ships. Hallmark is the rulebook the LLM never read.",
  ...
  garden: {
    ...
    title: HERO_TITLE,
    lede: "Twenty-one themes that disagree with each other on purpose. Pick one and the whole page changes — not the colours, the bones.",
    ctaLabel: "Plant it",
  ...
  studio: {
    eyebrow: "Studio · 2026",
    title: HERO_TITLE,
    lede: "We design and build distinctive products for ambitious teams. Hallmark is our typography opinion, codified — twenty-one themes, twenty-one shapes, no defaults.",
    ctaLabel: "Engage",
  ...
  lumen: {
    ...
    title: HERO_TITLE,
    lede: "a design skill that refuses the defaults every model was trained on. twenty-one themes, twenty-one page-shapes, and one slop test that gates every build before it ships.",
    ctaLabel: "install",
    proofLabel: "00 · SPEC",
    proofA: "21 page-shapes · 50 archetypes",
  ...
  hum: {
    ...
    lede: "The anti-slop design skill for Claude Code, Cursor, and Codex. Twenty-one themes with real structural variety, and a 57-gate check before anything ships.",
    ctaLabel: "Install",
    ...
    letterBody: "Every model defaults to the same page. Hum is the warm end of the refusal — cream paper, three accents that take turns, one small mark that reacts when you click. Twenty-one themes in the catalog, each with its own bones.",
    signoff: "— Hum",
    captionA: "Today",
    captionB: "Kept warm",
  },
