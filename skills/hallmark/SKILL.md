...
- [`data-viz.md`](references/data-viz.md) — load only when the brief involves dashboards, analytics, KPIs, charts, graphs, sparklines, heatmaps, or admin/observability surfaces. Charts inherit theme tokens; rainbow palettes, 3D pies, and dual-axis spaghetti are banned. Do not pre-load for a landing page with a single hero stat.
